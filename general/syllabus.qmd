...
**Energy System Design and Investment Planning (VIII)**\
A case study on energy system design and investment planning
...
**Framework for Multi-Energy Systems Optimization (XI)**\
A case study with the general framework for multi-energy systems optimization

**Recap and Discussion (XII)**\
We repeat the concepts from the course and discuss all your remaining questions

**Electricity Markets (XIII)**\
An overview of electricity markets and their role in the energy system
