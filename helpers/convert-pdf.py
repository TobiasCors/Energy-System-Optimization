...
def convert_all_pdfs_to_svgs(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith('.pdf'):
            ...
            output_svg_path = os.path.join(output_folder, f"eso_arena-{os.path.splitext(filename)[0]}.svg")
...
# Example usage
input_folder = '/Users/tobiascors/Desktop/img'
output_folder = '/Users/tobiascors/Desktop/img'
