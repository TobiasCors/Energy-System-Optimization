...
- Every Wednesday between 10.00 AM and 11.45 AM
...
- Moodle link: [https://moodle.haw-hamburg.de/course/view.php?id=10960](https://moodle.haw-hamburg.de/course/view.php?id=10960)
- Please join the course on Moodle and activate the notifications for the lecture
...
- In total maximum 6.0 bonus points can be earned (10% of the exam)
...
7. Storages
8. Energy System Design and Investment Planning

## Part III (preliminary)

9. Multi-Energy Systems
10. Intermission: Exam Preparation
11. Framework for Multi-Energy Systems Optimization
